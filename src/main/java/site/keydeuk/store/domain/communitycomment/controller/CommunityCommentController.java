...
public class CommunityCommentController {
    ...
    public CommonResponse<?> getCommentByCommentId(@PathVariable @Parameter(description = "커뮤니티 ID", required = true)Long communityId
                                            ,@PathVariable @Parameter(description = "마지막 댓글 ID", required = true)Long commentId){

        return CommonResponse.ok(commentService.findNext5CommentsByLastCommentId(communityId,commentId));
    }
}
